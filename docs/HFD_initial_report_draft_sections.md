...
> Historical draft preserved during consolidation. Read [EDA_REVIEW.md](EDA_REVIEW.md) before reusing numerical or modeling claims. Referenced figures are preserved in [the original figure folder](../archive/contributions/hfd_eda/figures/). Current results are in [the consolidated EDA report](../reports/eda/README.md).
